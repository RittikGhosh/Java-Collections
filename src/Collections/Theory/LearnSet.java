...
public class LearnSet {
    ...
    public static void main(String[] args) {
        ...
        //So if student class does not implements equals and hashcode functions(which are methods of Object class) then
        //set will treat each obj as unique. We can define what we want as unique
